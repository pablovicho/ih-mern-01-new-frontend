...
export default function Single() {
  ...
  <div class="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-x-8">
    ...
    <div class="lg:max-w-lg lg:self-end">
        ...
        <ol role="list" class="flex items-center space-x-2">
          <li>
            <div class="flex items-center text-sm">
              <Link to="/guitarras" class="font-medium text-gray-500 hover:text-gray-900">
                Guitarras
              </Link>
      ...
      <div class="mt-4">
        <h1 class="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">{singleGuitar.nombre}</h1>
      </div>
      ...
      <section aria-labelledby="information-heading" class="mt-4">
        ...
        <div class="flex items-center">
          <p class="text-lg text-gray-900 sm:text-xl">MXN ${singleGuitar.precio}</p>
        ...
        <div class="mt-4 space-y-6">
          <p class="text-base text-gray-500">{singleGuitar.description}</p>
        </div>
    ...
    <div class="mt-10 lg:mt-0 lg:col-start-2 lg:row-span-2 lg:self-center">
      <div class="aspect-w-1 aspect-h-1 rounded-lg overflow-hidden">
        <img src={singleGuitar.imagen} alt="Imagen de guitarra" class="w-full h-full object-center object-cover"/>
      </div>
    </div>
